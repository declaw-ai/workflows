...
| **`AuditConfig`** with structured event log | Per-action audit record (operator + agent + data + destination + timestamp) — replayable evidence for DPDP, SEBI, RBI digital-lending and FinCEN examinations. |
