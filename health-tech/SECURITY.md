...
SecurityPolicy(
    ...
    injection_defense=InjectionDefenseConfig(
        ...
        judge=InjectionJudgeConfig(enabled=True, policy=…),  # + Tier-2 LLM judge
    ),
...
The Tier-2 LLM judge reads the step's `agent_policy` to tell task-aligned
